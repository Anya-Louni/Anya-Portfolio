...
export const APPS: AppDef[] = [
  ...
  },
  {
    ...
    title: 'Aquarium',
    icon: 'aquarium',
    blurb: 'Seven fish, no feeding needed',
    w: 760,
    h: 500,
    minW: 340,
    minH: 240,
  ...
  },
  {
    ...
    icon: 'explorer',
    blurb: 'The web now, and the web in 1998',
    w: 940,
    h: 660,
    minW: 520,
    minH: 400,
  ...
  },
  {
    ...
    title: 'iPod',
    icon: 'ipod',
    blurb: 'Music, and yours if you add any',
    w: 320,
    h: 560,
    minW: 300,
    minH: 520,
  ...
  },
  {
    ...
    title: 'Terminal',
    icon: 'terminal',
    blurb: 'Type commands, the old way',
    w: 700,
    h: 460,
    minW: 380,
    minH: 260,
  ...
  },
  {
    ...
    icon: 'user',
    blurb: 'Change your sign-in picture',
    w: 760,
    h: 560,
    minW: 560,
    minH: 460,
  ...
  },
  {
    ...
    title: 'Chess',
    icon: 'games',
    blurb: 'Checkmate the other king',
    w: 860,
    h: 660,
    minW: 520,
    minH: 460,
  ...
  },
  {
    ...
    title: 'ASCII Studio',
    icon: 'ascii',
    blurb: 'Draw in characters, or build a kaomoji',
    w: 900,
    h: 660,
    minW: 620,
    minH: 480,
  ...
  },
  {
    ...
    title: 'Photo Booth',
    icon: 'camera',
    blurb: 'Camera and filters, nothing sent anywhere',
    w: 620,
    h: 700,
    minW: 460,
    minH: 520,
  ...
  },
  {
    ...
    icon: 'wmp',
    blurb: 'Music, with the moving lights',
    w: 780,
    h: 620,
    minW: 520,
    minH: 460,
  ...
  },
  {
    ...
    title: 'Notes',
    icon: 'sticky',
    blurb: 'Yours, or one you send to Anya',
    w: 560,
    h: 560,
    minW: 360,
    minH: 440,
  ...
  },
  {
    ...
    title: 'Privacy',
    icon: 'notes',
    blurb: 'What is kept and what is sent',
    w: 620,
    h: 620,
    minW: 420,
    minH: 400,
